...
func init() {
	...
	pctx.StaticVariable("DexFlags", "-JXX:OnError='cat hs_err_pid%p.log' -JXX:CICompilerCount=6 -JXX:+UseDynamicNumberOfGCThreads -JDcom.android.tools.r8.disableEnqueuerDeferredTracing=true")
